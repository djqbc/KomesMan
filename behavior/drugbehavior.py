from myevents import COLLISION_EVENT, GAME_EVENT, SCREEN_EFFECT_EVENT, ENTITY_EFFECT_EVENT, ScreenEffectEvent, EventType,\
    ...
    def input(_event, _postEventCallback):
        if _event.type == COLLISION_EVENT:
            ...
            if entity.artifacts[TagArtifact.NAME].type == TagType.KOMESMAN:
                _postEventCallback(pygame.event.Event(ENTITY_EFFECT_EVENT, effect=EntityEffect.PLAY_SOUND, path="res/sound/snort.wav"))
