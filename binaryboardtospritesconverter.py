            ...
            for cell in row:
                if cell == 1:
                    if (x==0 and y==0 and board[y][x+1] == 1 and board[y+1][x] == 1) \
                            or (x == 0 and y < maxY-1 and board[y-1][x] != 1 and board[y][x+1] == 1 and board[y+1][x] == 1)\
                            or (x < maxX-1 and y< maxY - 1 and board[y-1][x] != 1 and board[y][x-1] != 1 and board[y][x+1] == 1 and board[y+1][x] == 1):
                        newRow.append(WallKind.CORNER_TOPLEFT)
                    elif (x==0 and y==0 and board[y+1][x] != 1 and board[y][x+1] == 1)\
                            or (x == 0 and y < maxY-1 and board[y+1][x] != 1 and board[y][x+1] == 1 and board[y-1][x] != 1)\
                            or (x < maxX-1 and y< maxY - 1 and board[y+1][x] != 1 and board[y][x+1] == 1 and board[y-1][x] != 1 and board[y][x-1] != 1):
                        newRow.append(WallKind.END_LEFT)
                    elif(y==0 and x < maxX-1 and board[y][x-1] == 1 and board[y][x+1] == 1 and board[y+1][x] != 1)\
                            or (y == maxY-1 and x < maxX-1 and board[y-1][x] != 1 and board[y][x-1] == 1 and board[y][x+1] == 1)\
                            or (y < maxY-1 and x < maxX-1 and board[y-1][x] != 1 and board[y][x-1] == 1 and board[y][x+1] == 1 and board[y+1][x] != 1):
                        newRow.append(WallKind.HORIZONTAL_WALL)
                    elif(x==0 and y < maxY-1 and board[y][x+1] != 1 and board[y-1][x] == 1 and board[y+1][x] == 1)\
                            or (x<maxX-1 and y<maxY-1 and board[y][x+1] != 1 and board[y-1][x] == 1 and board[y+1][x] == 1 and board[y][x-1] != 1)\
